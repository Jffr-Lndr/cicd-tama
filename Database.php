...
abstract class Database
{
    ...
    public static function rawQueryWithReturnOne(string $query)
    {
        $pdo = self::getDatabase();
        $stmt = $pdo->prepare($query);
        $stmt->execute();
    ...
    public static function rawQueryWithReturnAll(string $query)
    {
        $pdo = self::getDatabase();
        $stmt = $pdo->prepare($query);
        $stmt->execute();
    ...
    public static function rawQueryForAddtamagotchi(string $query,int $id)
    {
        $pdo = self::getDatabase();
        $stmt = $pdo->prepare($query,$id);
        $stmt->execute();
    }
